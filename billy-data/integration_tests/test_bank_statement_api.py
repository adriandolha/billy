...
class TestBankStatementAPI:
    ...
    def test_bank_statement_transform_(self, config_valid, yahoo_config_valid, process_event_valid,
        ...
        files = [f'{config_valid["cognito_user"]}/bank_statements/upload/RO13BTRL01301201C53812XX-7.pdf']
        # files = [f'{config_valid["cognito_user"]}/bank_statements/upload/RO13BTRL01301201C53812XX.pdf']
        # files = [f'{config_valid["cognito_user"]}/bank_statements/upload/RO30BTRLEURCRT00C5381201 2.pdf']
